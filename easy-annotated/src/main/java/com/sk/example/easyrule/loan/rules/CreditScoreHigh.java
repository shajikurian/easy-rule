 ...
 */
@Slf4j
@Rule(name = "Credit score high", description = "Checking Credit Score greater than 750", priority = 6)
public class CreditScoreHigh {
    @Condition
    ...
    public void then(@Fact("rate") Rate rate){
        log.info("taking action based on credit score high");
